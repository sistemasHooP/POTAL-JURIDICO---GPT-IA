...
(function () {
    ...
    let clienteModalBusy = false;

    function setClienteButtonLoading(btn, isLoading, text) {
        if (!btn) return;
    ...
    async function salvarCliente(e) {
        ...
        clienteModalBusy = true;
        setClienteButtonLoading(btn, true, editId ? 'Salvando alterações...' : 'Cadastrando...');
